...
#pragma warning disable 0649
        [SerializeField]
        public Text argsText_1;
        [SerializeField]
        public Text argsText_2;
...
#pragma warning restore 0649
        ...
        void Awake()
        {
            ...
            //UnityHubで引数を与える場合はargs[4]に最初の引数が代入される
            argsText_1.text = args[0];
            argsText_2.text = args[1];

            urlSignaling = args[1].ToString();
